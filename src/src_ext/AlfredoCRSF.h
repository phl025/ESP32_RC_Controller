...
public:
    ...
    static const unsigned int CRSFFAILSAFE_STAGE1_MS = 300;
    //uint32_t rdCount;       // Add PHL, read counter
    //bool newRCData;         // Add PHL, new RC channels datas
    ...
    // Add PHL
    bool newChannelsPacket();
    uint8_t getBuffer(int index) const {return _rxBuf[index];}
